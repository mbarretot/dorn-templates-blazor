using Xunit;
using ToggleGroupComponent = CleanArchBlazorServer.Web.Components.Ui.ToggleGroup.ToggleGroup<string>;

namespace CleanArchBlazorServer.Application.Tests.Ui.ToggleGroup;
