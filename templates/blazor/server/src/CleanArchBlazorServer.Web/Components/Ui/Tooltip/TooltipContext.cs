...
namespace CleanArchBlazorServer.Web.Components.Ui.Tooltip;

// Cascaded by Tooltip so TooltipTrigger/TooltipContent (siblings) share open state and positioning.
public sealed class TooltipContext
{
    ...
    public string Side { get; internal set; } = "top";
